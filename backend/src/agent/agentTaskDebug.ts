...
function summarizeProductionFinalResult(data: ProductionFinalResultData) {
  ...
  return {
    ...
    groundingHardRepairReasons: data.groundingReport.llmGuard.hardRepairReasons ?? [],
    groundingSoftWarningReasons: data.groundingReport.llmGuard.softWarningReasons ?? [],
    groundingRepairReasonCounts: data.groundingReport.llmGuard.repairReasonCounts ?? {},
