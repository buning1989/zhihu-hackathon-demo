...
后端已经生成了完整、安全、可追溯的 demo.v1 baseResponse。你的任务不是重建 response，也不是总结每篇内容，而是基于 originalQuery / userCoreQuestion / focusTags / topicSignals / finalCandidates / evidenceExtract，把已有 paths / people / personas 的展示文案改成“用户意图 × 候选内容 × 差异化路径提炼”。
