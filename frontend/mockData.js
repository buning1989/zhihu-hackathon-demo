  ...
  const paths = [
    {
      ...
      representativeQuote: "我不是突然找到热爱，只是先把每天最痛的那一块拆小了。",
      peopleIds: ["person-ahe", "person-chengye"]
    },
    {
      id: "path-city",
      title: "换个地方，先住一小段时间看看",
      shortTitle: "换个试验场",
      summary: "适合已经能远程或短期空档的人。用一个周期测试生活成本、社交密度、身体状态和工作边界。",
      whyRelevant: "这些公开内容都在讲迁移不是逃跑，而是用更小代价验证一种生活假设。",
  ...
  const people = [
    {
      ...
      chatReplies: [
        "按这段公开内容，关键不是一下子做大决定，而是先把最消耗人的场景具体化。能被写下来、拿出来谈的部分，才可能被改变。",
    ...
    },
    {
      ...
      chatReplies: [
        "这段公开内容里，作品的作用不是炫耀，而是把模糊愿望变成可被讨论的证据。",
